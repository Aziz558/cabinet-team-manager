...
DEFAULT_SETTINGS = [
    ...
    {'cle': 'PENNYLANE_API_KEY', 'valeur': '', 'service': 'pennylane', 'type_valeur': 'password', 'masque': True},
    {'cle': 'PENNYLANE_BASE_URL', 'valeur': '', 'service': 'pennylane', 'type_valeur': 'string', 'masque': False},
    {'cle': 'PENNYLANE_COMPANY_ID', 'valeur': '', 'service': 'pennylane', 'type_valeur': 'string', 'masque': False},
