    ...
    try:
        ...
        if 'dossiers' in inspector.get_table_names():
            ...
            with db.engine.begin() as conn:
                ...
                if 'date_acompte_1' not in dossiers_cols:
                    conn.execute(db.text("ALTER TABLE dossiers ADD COLUMN date_acompte_1 DATE"))
                    app.logger.info("Added date_acompte_1 column to dossiers")
